 ...
 */
public class GrossProfitFragment extends Fragment {
    ...
    public void setChart(List<float[]> data, Activity activity) {
        ...
        chart = (BarChart) activity.findViewById(R.id.profit_chart);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_gross_profit, container, false);

        // Call when this is not the first Tab to open, so the data is already in stockService.java.

        chart = (BarChart) view.findViewById(R.id.profit_chart);
        List<float[]> data = CompanyInfoService.getProfitData();
